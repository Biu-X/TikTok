...
type Comment struct {
	...
	CreatedAt time.Time      `gorm:"column:created_at;type:datetime(3);comment:评论发布日期" json:"created_at"`                                         // 评论发布日期
	DeletedAt gorm.DeletedAt `gorm:"column:deleted_at;type:datetime(3);index:idx_comment_deleted_at,priority:1;comment:评论删除日期" json:"deleted_at"` // 评论删除日期
}
